...
//		dllName = "xgame" + "0.2.54.1";
		dllName = "xgame" + Version.Instance.GetVersion(VersionType.App) + "." + m_lastVersion;
		string path = parentPath + "/buildDll.bat";
		System.Diagnostics.Process.Start(path, dllName); 
		//EnDLL();
        //BuildAssetsBundleEditor.GenLuaFiles();
	...
	static string ReplaceCofigStr(string path)
	{
		...
		using (StreamWriter writer = new StreamWriter(path, false))
		{
			dllName = "xgame" + Version.Instance.GetVersion(VersionType.App) + ".1";
