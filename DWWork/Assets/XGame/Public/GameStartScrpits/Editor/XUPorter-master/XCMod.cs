...
namespace UnityEditor.XCodeEditor 
{
	public class XCMod 
	{
		...
		public ArrayList movefolders
		{
			
			get
			{
				return (ArrayList)_datastore["movefolders"];
			}
		}

        public ArrayList movefiles
        {

        get
            {
                return (ArrayList)_datastore["movefiles"];
            }
        }
		...
		{	
			...
			Debug.LogWarning( "XCMod init name = " + name );
			Debug.LogWarning( "XCMod init path = " + path );
