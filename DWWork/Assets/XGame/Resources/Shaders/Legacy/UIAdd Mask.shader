...
Shader "XGame2/UIEZFun/Additive Mask" 
{
	Properties 
	{
		...
		[Toggle(UNITY_UI_MASKCLIP)] _UseUIMaskClip("Use Mask Clip", Float) = 0
	...
	Category 
	{
		...
		SubShader 
		{
			Pass 
			{
				...
				#pragma multi_compile _DUMMY UNITY_UI_MASKCLIP
...
#ifdef UNITY_UI_MASKCLIP
					c.rgb *= UnityGet2DClipping(i.worldPosition.xy, _ClipRect);
#endif
					return 2.0f * i.color * _TintColor * c * _GlowScale;
				}
				ENDCG 
			}
		}
