...
Shader "EZFun/Dissolution_Blend" {
    Properties {
...
////// Emissive:
				...
				half node_1423 = (i.vertexColor.a*_N_mask);
				half4 _T_mask_var = tex2D(_T_mask,TRANSFORM_TEX(i.uv0, _T_mask));
				half node_5746_if_leA = step(node_1423,_T_mask_var.r);
				half node_5746_if_leB = step(_T_mask_var.r,node_1423);
				half node_3073 = 0.0;
				half node_6272 = 1.0;
				half node_5746 = lerp((node_5746_if_leA*node_3073)+(node_5746_if_leB*node_6272),node_6272,node_5746_if_leA*node_5746_if_leB);
				half node_5217_if_leA = step(node_1423,(_T_mask_var.r+_N_BY_KD));
				half node_5217_if_leB = step((_T_mask_var.r+_N_BY_KD),node_1423);
				...
				half3 finalColor = emissive + ((node_1274*_C_BYcolor.rgb)*_N_BY_QD);
