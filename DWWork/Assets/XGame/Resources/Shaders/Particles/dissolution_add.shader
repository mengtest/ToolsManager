...
////// Emissive:
				...
				half node_654 = (i.vertexColor.a*_N_mask);
				half4 _MaskTexture_var = tex2D(_MaskTexture,TRANSFORM_TEX(i.uv0, _MaskTexture));
				half node_5746_if_leA = step(node_654,_MaskTexture_var.r);
				half node_5746_if_leB = step(_MaskTexture_var.r,node_654);
				half node_3073 = 0.0;
				half node_6272 = 1.0;
				half node_5746 = lerp((node_5746_if_leA*node_3073)+(node_5746_if_leB*node_6272),node_6272,node_5746_if_leA*node_5746_if_leB);
				half node_5217_if_leA = step(node_654,(_MaskTexture_var.r+_N_BY_KD));
				half node_5217_if_leB = step((_MaskTexture_var.r+_N_BY_KD),node_654);
				half node_1274 = (node_5746-lerp((node_5217_if_leA*node_3073)+(node_5217_if_leB*node_6272),node_6272,node_5217_if_leA*node_5217_if_leB));
				half node_6450 = (node_5746+node_1274);
				half3 node_7666 = ((node_1274*_C_BYcolor.rgb)*_N_BY_QD);
				half3 emissive = (_TintColor.a*(((_TintColor.rgb*_MainTex_var.rgb)*node_6450)+node_7666));
				half3 finalColor = emissive + (_TintColor.a*node_7666);
				half node_6644 = (_TintColor.a*(_MainTex_var.a*node_6450));
