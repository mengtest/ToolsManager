...
local DDZHandCardCtrl = require "Area.DouDiZhu.UIWindow.UICtrl.UIDDZHandCardCtrl"
...
local OpreateCtrl = require "Area.DouDiZhu.UIWindow.UICtrl.UIDDZOperateCardCtrl"
local LordOpenCardsCtrl = require "Area.DouDiZhu.UIWindow.UICtrl.UIDDZLordOpenCardsCtrl"
