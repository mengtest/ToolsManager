...
local ChatMessageParser = { inited = false }
...
function ChatMessageParser:init()
	if self.inited then return end

    local words = require("LuaWindow.Chat.ChatSensitiveCfg")
...
function ChatMessageParser:getString(s)
