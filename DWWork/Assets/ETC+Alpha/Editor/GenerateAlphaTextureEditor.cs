...
public class GenerateAlphaTextureEditor : EditorWindow
{
    ...
    //[MenuItem("EZFun/ETC+Alpha/GenerateAlphaTexture")]
            ...
            {            
                ...
                if (GUI.Button(new Rect(270, y + 60, 140, 20), "Generate"))
                {
                    try
                    {
						...
						_etcAlphaInfos[i].SoureTextureImporter.SetPlatformTextureSettings("Android",2048,TextureImporterFormat.RGBA32, 100, false);
                        ...
                        int size = _etcAlphaInfos[i].AlphaTexture.width >= _etcAlphaInfos[i].AlphaTexture.height ? _etcAlphaInfos[i].AlphaTexture.width : _etcAlphaInfos[i].AlphaTexture.height;
                        _etcAlphaInfos[i].AlphaTextureImporter.SetPlatformTextureSettings("Android", size, TextureImporterFormat.ETC_RGB4, 100, false);                      
						_etcAlphaInfos[i].SoureTextureImporter.SetPlatformTextureSettings("Android", size, TextureImporterFormat.ETC_RGB4, 100, false);


                        _etcAlphaInfos[i].AlphaTextureImporter.SetPlatformTextureSettings("iPhone", size, TextureImporterFormat.PVRTC_RGB4, 100, false);
                        _etcAlphaInfos[i].SoureTextureImporter.SetPlatformTextureSettings("iPhone", size, TextureImporterFormat.ETC_RGB4, 100, false);
