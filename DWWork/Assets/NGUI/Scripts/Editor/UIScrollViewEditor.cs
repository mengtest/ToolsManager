...
public class UIScrollViewEditor : Editor
{
	public override void OnInspectorGUI ()
	{
		...
		SerializedProperty sp = NGUIEditorTools.DrawProperty("Movement", serializedObject, "m_movement");
		...
		NGUIEditorTools.DrawProperty("Direction", serializedObject, "movement");
