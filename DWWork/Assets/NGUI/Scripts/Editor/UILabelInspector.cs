...
public class UILabelInspector : UIWidgetInspector
{
	...
	protected override bool ShouldDrawProperties ()
	{
		...
		if (mFontType == FontType.NGUI)
		{
            ...
            serializedObject.FindProperty("mTrueTypeFontName").stringValue = "";

            if (fnt.objectReferenceValue != null)
			{
				if (GUI.changed) serializedObject.FindProperty("mTrueTypeFont").objectReferenceValue = null;
                serializedObject.FindProperty("mFontName").stringValue = fnt.objectReferenceValue.name;
		...
		else
		{
            ...
            serializedObject.FindProperty("mFontName").stringValue = "";

            if (ttf.objectReferenceValue != null)
			{
				if (GUI.changed) serializedObject.FindProperty("mFont").objectReferenceValue = null;
                serializedObject.FindProperty("mTrueTypeFontName").stringValue = ttf.objectReferenceValue.name;
