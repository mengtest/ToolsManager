...
public class UIBasicSpriteEditor : UIWidgetInspector
{
	...
	protected override void DrawCustomProperties ()
	{
		...
		if (type == UISprite.Type.Simple)
		{
            ...
            // Mingrui Jiang add
            NGUIEditorTools.DrawProperty("TopLeft", serializedObject, "mTopLeft");
            NGUIEditorTools.DrawProperty("TopRight", serializedObject, "mTopRight");
            NGUIEditorTools.DrawProperty("BottomLeft", serializedObject, "mBottomLeft");
            NGUIEditorTools.DrawProperty("BottomRight", serializedObject, "mBottomRight");
            NGUIEditorTools.DrawProperty("Round", serializedObject, "mRound");
            NGUIEditorTools.DrawProperty("Detail", serializedObject, "mDetailLevel");
        }
		...
		else if (type == UISprite.Type.Filled)
		{
            ...
            NGUIEditorTools.DrawProperty("Angel", serializedObject, "m_angel", GUILayout.MinWidth(20f));
		}
		else if (type == UISprite.Type.Advanced)
		{
            ...
            NGUIEditorTools.DrawProperty("  TopLeft", serializedObject, "topLeftType");
            NGUIEditorTools.DrawProperty("  TopRight", serializedObject, "topRightType");
            NGUIEditorTools.DrawProperty("  BottomLeft", serializedObject, "bottomLeftType");
            NGUIEditorTools.DrawProperty("  BottomRight", serializedObject, "bottomRightType");
			NGUIEditorTools.DrawProperty("Flip", serializedObject, "mFlip");
		}
