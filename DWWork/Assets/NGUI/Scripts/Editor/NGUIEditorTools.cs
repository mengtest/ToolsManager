...
public static class NGUIEditorTools
{
	...
	{
        return DrawProperty(label, serializedObject, property, padding, false, options);
	}

    static public SerializedProperty DrawProperty(string label, SerializedObject serializedObject, string property, bool padding, bool isReadonly, params GUILayoutOption[] options)
    {
        ...
        else DebugEz.LogWarning("Unable to find property " + property);
        return sp;
    }

    static public SerializedProperty DrawRawProperty(string label, SerializedObject serializedObject, string property, bool isReadonly, bool wrapInContent, params GUILayoutOption[] options)
    {
        SerializedProperty sp = serializedObject.FindProperty(property);
