...
public partial class TableView : IDisposable 
{
    ...
    public bool AddColumn(string colDataPropertyName, string colTitleText, float widthByPercent, TextAnchor alignment = TextAnchor.MiddleCenter, string fmt = "")
    {
        ...
        desc.PropertyInfo = m_itemType.GetProperty(desc.PropertyName, BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.GetField);
        if (desc.FieldInfo == null && desc.PropertyInfo == null)
        {
