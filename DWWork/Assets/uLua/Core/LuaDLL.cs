...
//#endif
		...
		[DllImport(LUADLL,CallingConvention = CallingConvention.Cdecl)]
		public static extern IntPtr lua_tolstring(IntPtr luaState, int index, out long strLen);
		...
		public static string lua_tostring(IntPtr luaState, int index)
		{
            ...
            if (str != IntPtr.Zero)
			{
                return Marshal.PtrToStringAnsi(str, (int)strlen);
			}
            else
			{
                return null;
        ...
        /// <summary>
        /// int 负数在ulua中会变的非常奇怪，这里直接用double来传递这个值，反正在lua和luajit中都是直接强转的
        /// </summary>
        /// <param name="luaState"></param>
        /// <param name="number"></param>
        public static void lua_pushinteger(IntPtr luaState, int number)
        {
