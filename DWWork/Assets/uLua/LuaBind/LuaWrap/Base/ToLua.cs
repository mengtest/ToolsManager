...
public static class ToLua 
{
    ...
    {
        Debug.Log("Begin Generate lua Wrap for class " + className + "\r\n");
        sb = new StringBuilder();                
    ...
    {
        string file = Application.dataPath + "/uLua/LuaBind/LuaWrap/" + wrapClassName + "Wrap.cs";
