...
public class UILabelWrap
{
	...
	static LuaField[] fields = new LuaField[]
	{
		...
		new LuaField("prefabEffectColor", get_prefabEffectColor, set_prefabEffectColor),
	...
	static int _CreateUILabel(IntPtr L)
	{
		...
		if (count == 0)
		{
			UILabel obj = new UILabel();
			LuaScriptMgr.Push(L, obj);
			return 1;
		}
		else
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: UILabel.New");
		}
	...
	{
		LuaScriptMgr.RegisterLib(L, "UILabel", typeof(UILabel), regs, fields, "UIWidget");
	}
	...
	static int get_keepCrispWhenShrunk(IntPtr L)
	{
		...
		LuaScriptMgr.PushEnum(L, obj.keepCrispWhenShrunk);
		return 1;
	}
	...
	static int get_gradientTop(IntPtr L)
	{
		...
		UILabel obj = (UILabel)o;
		LuaScriptMgr.PushValue(L, obj.gradientTop);
		return 1;
	}
	...
	static int get_gradientBottom(IntPtr L)
	{
		...
		UILabel obj = (UILabel)o;
		LuaScriptMgr.PushValue(L, obj.gradientBottom);
		return 1;
	}
	...
	static int get_symbolStyle(IntPtr L)
	{
		...
		UILabel obj = (UILabel)o;
		LuaScriptMgr.PushEnum(L, obj.symbolStyle);
		return 1;
	}
	...
	static int get_overflowMethod(IntPtr L)
	{
		...
		UILabel obj = (UILabel)o;
		LuaScriptMgr.PushEnum(L, obj.overflowMethod);
		return 1;
	}
	...
	static int get_effectStyle(IntPtr L)
	{
		...
		UILabel obj = (UILabel)o;
		LuaScriptMgr.PushEnum(L, obj.effectStyle);
		return 1;
	}
	...
	static int get_effectColor(IntPtr L)
	{
		...
		UILabel obj = (UILabel)o;
		LuaScriptMgr.PushValue(L, obj.effectColor);
		return 1;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_prefabEffectColor(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		...
		if (o == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name prefabEffectColor");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index prefabEffectColor on a nil value");
			}
		}

		UILabel obj = (UILabel)o;
		LuaScriptMgr.PushValue(L, obj.prefabEffectColor);
		return 1;
	}
	...
	static int get_effectDistance(IntPtr L)
	{
		...
		UILabel obj = (UILabel)o;
		LuaScriptMgr.PushValue(L, obj.effectDistance);
		return 1;
	}
	...
	static int get_printedSize(IntPtr L)
	{
		...
		UILabel obj = (UILabel)o;
		LuaScriptMgr.PushValue(L, obj.printedSize);
		return 1;
	}
	...
	static int set_bitmapFont(IntPtr L)
	{
		...
		UILabel obj = (UILabel)o;
		obj.bitmapFont = LuaScriptMgr.GetNetObject<UIFont>(L, 3);
		return 0;
	}
	...
	static int set_trueTypeFont(IntPtr L)
	{
		...
		UILabel obj = (UILabel)o;
		obj.trueTypeFont = LuaScriptMgr.GetNetObject<Font>(L, 3);
		return 0;
	}
	...
	static int set_ambigiousFont(IntPtr L)
	{
		...
		UILabel obj = (UILabel)o;
		obj.ambigiousFont = LuaScriptMgr.GetNetObject<Object>(L, 3);
		return 0;
	}
	...
	static int set_gradientTop(IntPtr L)
	{
		...
		UILabel obj = (UILabel)o;
		obj.gradientTop = LuaScriptMgr.GetNetObject<Color>(L, 3);
		return 0;
	}
	...
	static int set_gradientBottom(IntPtr L)
	{
		...
		UILabel obj = (UILabel)o;
		obj.gradientBottom = LuaScriptMgr.GetNetObject<Color>(L, 3);
		return 0;
	}
	...
	static int set_effectColor(IntPtr L)
	{
		...
		UILabel obj = (UILabel)o;
		obj.effectColor = LuaScriptMgr.GetNetObject<Color>(L, 3);
		return 0;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_prefabEffectColor(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		...
		UILabel obj = (UILabel)o;
		obj.prefabEffectColor = LuaScriptMgr.GetNetObject<Color>(L, 3);
		return 0;
	}
	...
	static int set_effectDistance(IntPtr L)
	{
		...
		UILabel obj = (UILabel)o;
		obj.effectDistance = LuaScriptMgr.GetNetObject<Vector2>(L, 3);
		return 0;
	}
	...
	static int GetSides(IntPtr L)
	{
		...
		UILabel obj = LuaScriptMgr.GetNetObject<UILabel>(L, 1);
	...
	static int GetCharacterIndexAtPosition(IntPtr L)
	{
		...
		Type[] types0 = {typeof(UILabel), typeof(Vector2), typeof(bool)};
		Type[] types1 = {typeof(UILabel), typeof(Vector3), typeof(bool)};
	...
	static int GetWordAtPosition(IntPtr L)
	{
		...
		Type[] types0 = {typeof(UILabel), typeof(Vector2)};
		Type[] types1 = {typeof(UILabel), typeof(Vector3)};
	...
	static int PrintOverlay(IntPtr L)
	{
		...
		Color arg5 = LuaScriptMgr.GetNetObject<Color>(L, 7);
