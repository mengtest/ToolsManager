...
public class UICameraWrap
{
	public static LuaMethod[] regs = new LuaMethod[]
	{
		...
		new LuaMethod("HideTooltip", HideTooltip),
	...
	static LuaField[] fields = new LuaField[]
	{
		...
		new LuaField("GetAnyKeyDown", get_GetAnyKeyDown, set_GetAnyKeyDown),
		...
		new LuaField("horizontalPanAxisName", get_horizontalPanAxisName, set_horizontalPanAxisName),
		new LuaField("verticalPanAxisName", get_verticalPanAxisName, set_verticalPanAxisName),
		...
		new LuaField("autoHideCursor", get_autoHideCursor, set_autoHideCursor),
		...
		new LuaField("ignoreControllerInput", get_ignoreControllerInput, set_ignoreControllerInput),
		...
		new LuaField("onSchemeChange", get_onSchemeChange, set_onSchemeChange),
		...
		new LuaField("onNavigate", get_onNavigate, set_onNavigate),
		new LuaField("onPan", get_onPan, set_onPan),
		...
		new LuaField("disableController", get_disableController, set_disableController),
		new LuaField("lastEventPosition", get_lastEventPosition, set_lastEventPosition),
		new LuaField("first", get_first, null),
		...
		new LuaField("inputHasFocus", get_inputHasFocus, null),
		new LuaField("cachedCamera", get_cachedCamera, null),
		new LuaField("tooltipObject", get_tooltipObject, null),
		new LuaField("isOverUI", get_isOverUI, null),
		new LuaField("hoveredObject", get_hoveredObject, set_hoveredObject),
		new LuaField("controllerNavigationObject", get_controllerNavigationObject, set_controllerNavigationObject),
	...
	{
		LuaScriptMgr.PushObject(L, UICamera.GetAnyKeyDown);
		return 1;
	}
	...
	static int get_horizontalPanAxisName(IntPtr L)
	{
		...
		if (o == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name horizontalPanAxisName");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index horizontalPanAxisName on a nil value");
			}
		}

		UICamera obj = (UICamera)o;
		LuaScriptMgr.Push(L, obj.horizontalPanAxisName);
		return 1;
	}
	...
	static int get_verticalPanAxisName(IntPtr L)
	{
		...
		if (o == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name verticalPanAxisName");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index verticalPanAxisName on a nil value");
			}
		}

		UICamera obj = (UICamera)o;
		LuaScriptMgr.Push(L, obj.verticalPanAxisName);
		return 1;
	}
	...
	static int get_autoHideCursor(IntPtr L)
	{
		...
		if (o == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name autoHideCursor");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index autoHideCursor on a nil value");
			}
		}

		UICamera obj = (UICamera)o;
		LuaScriptMgr.Push(L, obj.autoHideCursor);
		return 1;
	}
	...
	{
		LuaScriptMgr.Push(L, UICamera.ignoreControllerInput);
		return 1;
	}
	...
	{
		LuaScriptMgr.PushObject(L, UICamera.onSchemeChange);
		return 1;
	}
	...
	{
		LuaScriptMgr.PushObject(L, UICamera.onNavigate);
		return 1;
	}
	...
	{
		LuaScriptMgr.PushObject(L, UICamera.onPan);
		return 1;
	}
	...
	{
		LuaScriptMgr.PushObject(L, UICamera.GetInputTouchCount);
		return 1;
	}
	...
	{
		LuaScriptMgr.PushObject(L, UICamera.GetInputTouch);
		return 1;
	}
	...
	{
		LuaScriptMgr.Push(L, UICamera.disableController);
		return 1;
	}
	...
	{
		LuaScriptMgr.PushValue(L, UICamera.lastEventPosition);
		return 1;
	}
	...
	{
		LuaScriptMgr.Push(L, UICamera.first);
		return 1;
	}
	...
	{
		LuaScriptMgr.Push(L, UICamera.tooltipObject);
		return 1;
	}
	...
	{
		LuaScriptMgr.Push(L, UICamera.controllerNavigationObject);
		return 1;
	}
	...
	{
		UICamera.GetAnyKeyDown = LuaScriptMgr.GetNetObject<UICamera.GetAnyKeyFunc>(L, 3);
		return 0;
	}
	...
	static int set_horizontalPanAxisName(IntPtr L)
	{
		...
		UICamera obj = (UICamera)o;
		obj.horizontalPanAxisName = LuaScriptMgr.GetString(L, 3);
		return 0;
	}
	...
	static int set_verticalPanAxisName(IntPtr L)
	{
		...
		UICamera obj = (UICamera)o;
		obj.verticalPanAxisName = LuaScriptMgr.GetString(L, 3);
		return 0;
	}
	...
	static int set_autoHideCursor(IntPtr L)
	{
		...
		UICamera obj = (UICamera)o;
		obj.autoHideCursor = LuaScriptMgr.GetBoolean(L, 3);
		return 0;
	}
	...
	{
		UICamera.ignoreControllerInput = LuaScriptMgr.GetBoolean(L, 3);
		return 0;
	}
	...
	{
		UICamera.onSchemeChange = LuaScriptMgr.GetNetObject<UICamera.OnSchemeChange>(L, 3);
		return 0;
	}
	...
	{
		UICamera.onNavigate = LuaScriptMgr.GetNetObject<UICamera.KeyCodeDelegate>(L, 3);
		return 0;
	}
	...
	{
		UICamera.onPan = LuaScriptMgr.GetNetObject<UICamera.VectorDelegate>(L, 3);
		return 0;
	}
	...
	{
		UICamera.activeTouches = LuaScriptMgr.GetNetObject<List<UICamera.MouseOrTouch>>(L, 3);
		return 0;
	}
	...
	{
		UICamera.GetInputTouchCount = LuaScriptMgr.GetNetObject<UICamera.GetTouchCountCallback>(L, 3);
		return 0;
	}
	...
	{
		UICamera.GetInputTouch = LuaScriptMgr.GetNetObject<UICamera.GetTouchCallback>(L, 3);
		return 0;
	}
	...
	{
		UICamera.disableController = LuaScriptMgr.GetBoolean(L, 3);
		return 0;
	}
	...
	{
		UICamera.lastEventPosition = LuaScriptMgr.GetNetObject<Vector2>(L, 3);
		return 0;
	}
	...
	{
		UICamera.controllerNavigationObject = LuaScriptMgr.GetNetObject<GameObject>(L, 3);
		return 0;
	}
	...
	static int Raycast(IntPtr L)
	{
		...
		Type[] types0 = {typeof(Vector3)};
		Type[] types1 = {typeof(UICamera.MouseOrTouch)};
		...
		{
			UICamera.MouseOrTouch arg0 = LuaScriptMgr.GetNetObject<UICamera.MouseOrTouch>(L, 1);
			UICamera.Raycast(arg0);
			return 0;
		}
		else
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: UICamera.Raycast");
		}
