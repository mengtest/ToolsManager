...
public class UIRectWrap
{
	public static LuaMethod[] regs = new LuaMethod[]
	{
		...
		new LuaMethod("SetScreenRect", SetScreenRect),
	...
	{
		LuaScriptMgr.Push(L, typeof(UIRect));
		return 1;
	}

	public static void Register(IntPtr L)
	{
		LuaScriptMgr.RegisterLib(L, "UIRect", typeof(UIRect), regs, fields, "UnityEngine.MonoBehaviour");
	}
	...
	static int set_leftAnchor(IntPtr L)
	{
		...
		UIRect obj = (UIRect)o;
		obj.leftAnchor = LuaScriptMgr.GetNetObject<UIRect.AnchorPoint>(L, 3);
		return 0;
	}
	...
	static int set_rightAnchor(IntPtr L)
	{
		...
		UIRect obj = (UIRect)o;
		obj.rightAnchor = LuaScriptMgr.GetNetObject<UIRect.AnchorPoint>(L, 3);
		return 0;
	}
	...
	static int set_bottomAnchor(IntPtr L)
	{
		...
		UIRect obj = (UIRect)o;
		obj.bottomAnchor = LuaScriptMgr.GetNetObject<UIRect.AnchorPoint>(L, 3);
		return 0;
	}
	...
	static int set_updateAnchors(IntPtr L)
	{
		...
		UIRect obj = (UIRect)o;
		obj.updateAnchors = LuaScriptMgr.GetNetObject<UIRect.AnchorUpdate>(L, 3);
		return 0;
	}
	...
	static int SetAnchor(IntPtr L)
	{
		...
		Type[] types2 = {typeof(UIRect), typeof(GameObject), typeof(float), typeof(float), typeof(float), typeof(float)};
		Type[] types3 = {typeof(UIRect), typeof(GameObject), typeof(int), typeof(int), typeof(int), typeof(int)};
		...
		else if (count == 10)
		{
			...
			int arg6 = (int)LuaScriptMgr.GetNumber(L, 8);
			float arg7 = (float)LuaScriptMgr.GetNumber(L, 9);
			int arg8 = (int)LuaScriptMgr.GetNumber(L, 10);
