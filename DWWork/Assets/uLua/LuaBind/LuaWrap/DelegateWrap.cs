...
public class DelegateWrap
{
	...
	{
		LuaScriptMgr.RegisterLib(L, "System.Delegate", typeof(Delegate), regs, fields, "System.Object");
	}
	...
	static int CreateDelegate(IntPtr L)
	{
		...
		Type[] types1 = {typeof(Type), typeof(MethodInfo), typeof(bool)};
		Type[] types2 = {typeof(Type), typeof(Type), typeof(string)};
		Type[] types3 = {typeof(Type), typeof(object), typeof(string)};
		Type[] types4 = {typeof(Type), typeof(object), typeof(MethodInfo)};
		Type[] types5 = {typeof(Type), typeof(Type), typeof(string), typeof(bool)};
		Type[] types6 = {typeof(Type), typeof(object), typeof(string), typeof(bool)};
		Type[] types7 = {typeof(Type), typeof(object), typeof(MethodInfo), typeof(bool)};
		Type[] types8 = {typeof(Type), typeof(Type), typeof(string), typeof(bool), typeof(bool)};
		Type[] types9 = {typeof(Type), typeof(object), typeof(string), typeof(bool), typeof(bool)};
		...
		else if (count == 4 && LuaScriptMgr.CheckTypes(L, types6, 1))
		{
			Type arg0 = LuaScriptMgr.GetTypeObject(L, 1);
			object arg1 = LuaScriptMgr.GetVarObject(L, 2);
			string arg2 = LuaScriptMgr.GetString(L, 3);
		...
		else if (count == 4 && LuaScriptMgr.CheckTypes(L, types7, 1))
		{
			Type arg0 = LuaScriptMgr.GetTypeObject(L, 1);
			object arg1 = LuaScriptMgr.GetVarObject(L, 2);
			MethodInfo arg2 = LuaScriptMgr.GetNetObject<MethodInfo>(L, 3);
		...
		else if (count == 5 && LuaScriptMgr.CheckTypes(L, types8, 1))
		{
			Type arg0 = LuaScriptMgr.GetTypeObject(L, 1);
			Type arg1 = LuaScriptMgr.GetTypeObject(L, 2);
			string arg2 = LuaScriptMgr.GetString(L, 3);
		...
		else if (count == 5 && LuaScriptMgr.CheckTypes(L, types9, 1))
		{
			Type arg0 = LuaScriptMgr.GetTypeObject(L, 1);
			object arg1 = LuaScriptMgr.GetVarObject(L, 2);
			string arg2 = LuaScriptMgr.GetString(L, 3);
